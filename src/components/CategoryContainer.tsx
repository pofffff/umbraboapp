...
export const CategoryContainer: FC<CategoryContainerProps> = memo(
    ({ category }) => {
        const [categoryVisible, setCategoryVisible] = useState<boolean>(false)
        const [visibleActivity, setVisibleActivity] =
